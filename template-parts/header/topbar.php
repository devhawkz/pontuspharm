...
$topbar_text      = pontus_get_header_setting('topbar_text', __('PROBAVNA ZENERGIJA — POUZDAN SADRŽAJ O PROBAVNOM ZDRAVLJU', 'pontus-zenergija'));
	...
	<div class="site-topbar__inner pontus-container">
		...
		<div class="site-topbar__socials" aria-label="<?php esc_attr_e('Social links', 'pontus-zenergija'); ?>">
			<?php if (!empty($instagram_url)) : ?>
				<a class="site-topbar__social-link" href="<?php echo esc_url($instagram_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Instagram', 'pontus-zenergija'); ?>">
			...
			<?php if (!empty($facebook_url)) : ?>
				<a class="site-topbar__social-link" href="<?php echo esc_url($facebook_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Facebook', 'pontus-zenergija'); ?>">
					<svg class="site-topbar__social-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
			...
			<?php if (!empty($youtube_url)) : ?>
				<a class="site-topbar__social-link" href="<?php echo esc_url($youtube_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('YouTube', 'pontus-zenergija'); ?>">
					<svg class="site-topbar__social-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
